      ...
      <div className="section-container max-w-3xl">
        ...
        <div className="space-y-8 text-neutral-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Los servicios ofrecidos consisten en atención psicológica individual para adultos en modalidad presencial (Xalapa, Veracruz) y en línea. El contenido de este sitio tiene fines informativos y <strong>no sustituye la atención directa</strong> ni el diagnóstico profesional.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Las citas se confirman por WhatsApp o correo electrónico.</li>
          ...
          <section>
            ...
            <p>
              Los honorarios se informan previamente a la primera sesión. Métodos de pago aceptados: efectivo, transferencia bancaria y tarjeta. Se emite recibo o factura cuando se solicite y aplique.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Para dudas sobre estos términos: WhatsApp 331 636 0640 · diego.navarro.psicologo@gmail.com
            </p>
          </section>
        </div>
      </div>
